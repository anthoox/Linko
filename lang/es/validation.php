...
return [
    ...
    | como las reglas de tamaño. Siéntete libre de retocar cada mensaje aquí.
    |
    */
    ...
    | rápido el especificar una línea de lenguaje específica para una regla dada.
    |
    */
    ...
    | posición de los atributos con algo más amigable para el usuario como
    | "Dirección de Correo" en lugar de "email". Esto ayuda a que los mensajes
    | sean más expresivos.
    |
    */
