        ...
        <footer class="w-full  border-gray-100 dark:border-gray-800 pb-0">
            <div class="max-w-5xl mx-auto flex flex-col items-center justify-center space-y-4">
                ...
                <div class="flex space-x-6 text-gray-500 text-sm">
                    <a href="#" class="hover:text-[#a371f7] transition-colors">Twitter</a>
                    <a href="#" class="hover:text-[#a371f7] transition-colors">GitHub</a>
                    <a href="#" class="hover:text-[#a371f7] transition-colors">Privacidad</a>
                    <a href="#" class="hover:text-[#a371f7] transition-colors">Contacto</a>
                </div>
            </div>
        </footer>
    </flux:main>
