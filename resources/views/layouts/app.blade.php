<x-layouts::app.header :title="$title ?? null">
    <flux:main>
        ...
        {{-- El footer va AQUÍ, dentro de flux:main --}}
        <footer class="w-full border-t border-gray-100 dark:border-gray-800 py-8 mt-12">
            <div class="max-w-5xl mx-auto px-4 flex flex-col items-center justify-center space-y-4">
