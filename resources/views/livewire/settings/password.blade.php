<section class="w-full max-w-5xl mx-auto">
    ...
    <x-settings.layout :heading="__('Actualizar contraseña')" :subheading="__('Asegúrese de que su cuenta esté usando una contraseña larga y aleatoria para mantenerse seguro')">
