    ...
    <x-settings.layout
        ...
        <div class="flex flex-col w-full mx-auto space-y-6 text-sm" wire:cloak>
            ...
            <div class="space-y-4">
                ...
                <flux:text>
                    {{ __('Con la autenticación de dos factores habilitada, se le solicitará un PIN seguro al iniciar sesión. Puede obtenerlo desde una aplicación compatible con TOTP en su teléfono.') }}
                </flux:text>
